...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "jhoauth2@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "jhoauth2 API";

        private String description = "jhoauth2 API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "jhoauth2";
